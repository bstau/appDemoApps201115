 ...
 * 
 */
Ext.define('Bloodbank.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Bloodbank.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
