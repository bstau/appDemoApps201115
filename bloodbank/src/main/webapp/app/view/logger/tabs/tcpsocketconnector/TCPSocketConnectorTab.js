...
Ext
		.define(
				'Bloodbank.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Bloodbank.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
