...
Ext
		.define(
				'Bloodbank.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Bloodbank.view.logger.tabs.details.DetailsTab',
							'Bloodbank.view.logger.tabs.fileconnector.FileConnectorTab',
							'Bloodbank.view.logger.tabs.dbconnector.DBConnectorTab',
							'Bloodbank.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Bloodbank.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Bloodbank.view.logger.LogConfigurationTabPanelController',
