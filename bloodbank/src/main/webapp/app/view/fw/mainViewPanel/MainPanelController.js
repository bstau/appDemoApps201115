Ext.define('Bloodbank.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Bloodbank.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Bloodbank.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
