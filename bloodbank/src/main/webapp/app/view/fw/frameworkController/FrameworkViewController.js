Ext.define('Bloodbank.view.fw.frameworkController.FrameworkViewController', {
    ...
    onConsoleClick: function() {
         var window = Ext.create('Bloodbank.view.console.ConsoleWindow');
  				...
  				var xtype = item.xtype;
  	   			...
  	   			if(xtype == 'panel' ||  xtype == "fieldset" || xtype == "form"){
  	   				...
  	   				if(xtype == 'datefield' || xtype == 'hidden' || 
  	   						...
  	   						xtype == "grids" || xtype == 'fileupload' || xtype== "checkbox"
  	   							)
  	   				{
