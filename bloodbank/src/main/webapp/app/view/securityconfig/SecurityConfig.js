 ...
 * 
 */
Ext.define('Bloodbank.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Bloodbank.view.securityconfig.SecurityConfigController',
			'Bloodbank.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
