...
Ext.define('Bloodbank.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Bloodbank.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Bloodbank.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
