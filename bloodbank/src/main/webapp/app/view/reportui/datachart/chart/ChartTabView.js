Ext.define('Bloodbank.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Bloodbank.view.reportui.datachart.chart.RatingField','Bloodbank.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
