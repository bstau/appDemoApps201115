Ext.define('Bloodbank.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Bloodbank.view.mobileview.reportui.datachart.chart.RatingField','Bloodbank.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
