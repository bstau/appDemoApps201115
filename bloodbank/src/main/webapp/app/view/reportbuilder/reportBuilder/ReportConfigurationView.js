Ext.define('Bloodbank.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Bloodbank.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Bloodbank.view.reportbuilder.gridconfig.GridConfigView',
	           'Bloodbank.view.reportbuilder.properties.PropertiesPanelView',
	           'Bloodbank.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
