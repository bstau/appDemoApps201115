Ext.define('Bloodbank.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Bloodbank.view.reportbuilder.reportlist.ReportListPanelView',
             'Bloodbank.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Bloodbank.view.reportbuilder.mainview.ReportMainController'
             ],
