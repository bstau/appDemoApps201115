Ext.define('Bloodbank.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Bloodbank.view.reportbuilder.properties.RptDataEndPointGridController'],
