 ...
 * 
 */
Ext.define('Bloodbank.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Bloodbank.view.logalarm.LogAlarmMainViewController',
			'Bloodbank.view.logalarm.tree.LogAlarmTreePanel',
			'Bloodbank.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
