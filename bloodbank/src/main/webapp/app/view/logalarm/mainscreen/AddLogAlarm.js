 ...
 * 
 */
Ext.define('Bloodbank.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Bloodbank.view.logalarm.mainscreen.AddLogAlarmController',
			'Bloodbank.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Bloodbank.view.logalarm.mainscreen.AppAlarmPanel',
