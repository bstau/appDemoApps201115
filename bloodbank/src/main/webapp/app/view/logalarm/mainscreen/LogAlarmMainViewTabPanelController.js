 ...
 * 
 */
Ext.define('Bloodbank.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Bloodbank.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
