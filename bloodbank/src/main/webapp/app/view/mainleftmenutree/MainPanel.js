Ext.define('Bloodbank.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Bloodbank.view.resource.ResourcePanel',
			'Bloodbank.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Bloodbank.view.resource.DockedResourcePanel','Bloodbank.view.fw.mainViewPanel.MainPanelController' ],
