Ext.define('Bloodbank.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Bloodbank.view.usermanagement.enduser.UserProfileController', 'Bloodbank.view.usermanagement.admin.AddUserDetailsViewModel', 'Bloodbank.model.AddUserDataModel' ],
