 ...
 * 
 */
Ext.define("Bloodbank.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Bloodbank.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
