Ext.define('Bloodbank.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Bloodbank.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
