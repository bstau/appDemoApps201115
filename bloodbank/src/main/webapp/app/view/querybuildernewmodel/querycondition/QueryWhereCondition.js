Ext.define('Bloodbank.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Bloodbank.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
