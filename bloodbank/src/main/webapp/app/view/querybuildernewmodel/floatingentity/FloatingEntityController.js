Ext.define('Bloodbank.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Bloodbank.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Bloodbank.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Bloodbank.view.querybuildernewmodel.floatingentity.EntitySprite',
