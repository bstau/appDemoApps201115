Ext.define('Bloodbank.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Bloodbank.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Bloodbank.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Bloodbank.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Bloodbank.view.querybuildernewmodel.querydetail.QueryDetail');
