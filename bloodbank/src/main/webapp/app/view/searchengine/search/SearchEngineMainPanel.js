Ext.define('Bloodbank.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Bloodbank.view.searchengine.search.NorthPanel', 'Bloodbank.view.searchengine.search.SearchResult','Bloodbank.view.searchengine.search.SearchEngineMainPanelController'],
