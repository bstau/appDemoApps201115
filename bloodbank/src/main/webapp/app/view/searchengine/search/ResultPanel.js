Ext
		.define(
				'Bloodbank.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Bloodbank.view.searchengine.search.SearchEngineMainPanelController','Bloodbank.view.searchengine.search.PanelHeaderField' ,'Bloodbank.view.searchengine.search.ReportGridView','Bloodbank.view.searchengine.search.ReportChartView','Bloodbank.view.searchengine.search.documentView','Bloodbank.view.searchengine.search.DouMeanView','Bloodbank.view.googlemaps.map.MapPanel'],
