 ...
 * 
 */
Ext.define('Bloodbank.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Bloodbank.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Bloodbank.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
