Ext.define('Bloodbank.bloodbank.web.com.controller.healthcare.DonationTypeMainController', {
     extend: 'Bloodbank.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.DonationTypeMainController',
     init: function() {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.donationTypeId;
          me = this;
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          debugger;
          var formPanel = this.getView().down('#DonationType');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#DonationType').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#DonationTypeGrid').store;
          gridStore.removeAll();
