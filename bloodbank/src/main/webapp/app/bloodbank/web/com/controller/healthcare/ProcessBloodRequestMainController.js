Ext.define('Bloodbank.bloodbank.web.com.controller.healthcare.ProcessBloodRequestMainController', {
     extend: 'Bloodbank.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.ProcessBloodRequestMainController',
     init: function() {
     ...
     bloodRequestIdLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               jsonData: {},
               success: function(response, scope) {
                    var compRef = scope.sender.down('#bloodRequestId');
                    scope.sender.controller.assignAllComboData(scope.sender, 'bloodRequestId', response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, compRef);
               },
               failure: function(response, scope) {
                    debugger;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.processBloodRequestId;
          me = this;
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          debugger;
          var formPanel = this.getView().down('#ProcessBloodRequest');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ProcessBloodRequest').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ProcessBloodRequestGrid').store;
          gridStore.removeAll();
