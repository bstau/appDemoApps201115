Ext.define('Bloodbank.bloodbank.web.com.controller.healthcare.BloodGroupMainController', {
     extend: 'Bloodbank.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.BloodGroupMainController',
     init: function() {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.bloodGrpId;
          me = this;
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          debugger;
          var formPanel = this.getView().down('#BloodGroup');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#BloodGroup').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#BloodGroupGrid').store;
          gridStore.removeAll();
