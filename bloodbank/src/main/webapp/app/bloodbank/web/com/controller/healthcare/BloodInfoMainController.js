Ext.define('Bloodbank.bloodbank.web.com.controller.healthcare.BloodInfoMainController', {
     extend: 'Bloodbank.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.BloodInfoMainController',
     init: function() {
     ...
     visitIdLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#visitId');
                    scope.sender.controller.assignAllComboData(scope.sender, 'visitId', response.responseText);
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.bInfoId;
          me = this;
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          debugger;
          var formPanel = this.getView().down('#BloodInfo');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#BloodInfo').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#BloodInfoGrid').store;
          gridStore.removeAll();
