Ext.define('Testprok.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testprok.view.querybuildernewmodel.querycondition.QuerySelectController',
