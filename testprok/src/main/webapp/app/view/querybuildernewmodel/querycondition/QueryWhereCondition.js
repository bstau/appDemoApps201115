Ext.define('Testprok.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testprok.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
