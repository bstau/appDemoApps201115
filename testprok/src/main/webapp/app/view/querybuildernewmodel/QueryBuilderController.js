Ext.define('Testprok.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testprok.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testprok.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testprok.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testprok.view.querybuildernewmodel.querydetail.QueryDetail');
