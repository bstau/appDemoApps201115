Ext.define('Testprok.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testprok.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
