Ext.define('Testprok.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testprok.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testprok.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testprok.view.querybuildernewmodel.floatingentity.EntitySprite',
