Ext.define('Testprok.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testprok.view.reportui.datachart.chart.RatingField','Testprok.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
