...
Ext.define('Testprok.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Testprok.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Testprok.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
