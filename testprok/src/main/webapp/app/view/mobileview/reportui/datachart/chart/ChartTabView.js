Ext.define('Testprok.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testprok.view.mobileview.reportui.datachart.chart.RatingField','Testprok.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
