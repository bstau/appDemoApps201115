Ext.define('Testprok.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testprok.view.usermanagement.admin.AddUserDetailsViewModel', 'Testprok.model.AddUserDataModel' ],
