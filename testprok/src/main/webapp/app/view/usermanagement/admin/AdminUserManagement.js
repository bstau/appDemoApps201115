Ext.define('Testprok.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testprok.view.usermanagement.admin.UserPasswordReset',
	            'Testprok.view.usermanagement.admin.AddUserDetails',
	            'Testprok.view.usermanagement.admin.ViewUser'],
