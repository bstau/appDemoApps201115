Ext.define('Testprok.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testprok.view.usermanagement.enduser.UserProfileController', 'Testprok.view.usermanagement.admin.AddUserDetailsViewModel', 'Testprok.model.AddUserDataModel' ],
