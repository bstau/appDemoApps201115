Ext.define('Testprok.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Testprok.view.resource.ResourcePanel',
			'Testprok.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Testprok.view.resource.DockedResourcePanel','Testprok.view.fw.mainViewPanel.MainPanelController' ],
