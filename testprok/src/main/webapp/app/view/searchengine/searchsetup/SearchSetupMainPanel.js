 ...
 * 
 */
Ext.define('Testprok.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Testprok.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Testprok.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
