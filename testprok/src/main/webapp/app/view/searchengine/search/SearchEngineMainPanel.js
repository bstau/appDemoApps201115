Ext.define('Testprok.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testprok.view.searchengine.search.NorthPanel', 'Testprok.view.searchengine.search.SearchResult','Testprok.view.searchengine.search.SearchEngineMainPanelController'],
