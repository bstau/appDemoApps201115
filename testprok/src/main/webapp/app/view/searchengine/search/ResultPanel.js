Ext
		.define(
				'Testprok.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testprok.view.searchengine.search.SearchEngineMainPanelController','Testprok.view.searchengine.search.PanelHeaderField' ,'Testprok.view.searchengine.search.ReportGridView','Testprok.view.searchengine.search.ReportChartView','Testprok.view.searchengine.search.documentView','Testprok.view.searchengine.search.DouMeanView','Testprok.view.googlemaps.map.MapPanel'],
