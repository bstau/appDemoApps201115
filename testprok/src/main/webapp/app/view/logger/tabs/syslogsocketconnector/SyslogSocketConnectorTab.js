 ...
 * 
 */
Ext.define('Testprok.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testprok.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
