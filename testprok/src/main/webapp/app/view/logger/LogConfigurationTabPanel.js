...
Ext
		.define(
				'Testprok.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testprok.view.logger.tabs.details.DetailsTab',
							'Testprok.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testprok.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testprok.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testprok.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testprok.view.logger.LogConfigurationTabPanelController',
