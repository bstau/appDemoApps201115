 ...
 * 
 */
Ext.define('Testprok.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testprok.view.logalarm.mainscreen.AddLogAlarmController',
			'Testprok.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testprok.view.logalarm.mainscreen.AppAlarmPanel',
