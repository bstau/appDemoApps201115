Ext.define('Testprok.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testprok.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testprok.view.reportbuilder.gridconfig.GridConfigView',
	           'Testprok.view.reportbuilder.properties.PropertiesPanelView',
	           'Testprok.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
