Ext.define('Testprok.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testprok.view.reportbuilder.reportlist.ReportListPanelView',
             'Testprok.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testprok.view.reportbuilder.mainview.ReportMainController'
             ],
