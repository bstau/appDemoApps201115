Ext.define('Testprok.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprok.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testprok.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testprok.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testprok.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
