Ext.define('Testprok.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprok.view.reportbuilder.properties.RptDataEndPointGridController'],
