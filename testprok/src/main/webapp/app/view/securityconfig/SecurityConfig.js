 ...
 * 
 */
Ext.define('Testprok.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testprok.view.securityconfig.SecurityConfigController',
			'Testprok.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
