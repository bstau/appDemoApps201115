...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("PnMphU6QOE04cQR4PMAxRnkf8pjjmnj0");
            country.setCapitalLatitude(4);
            country.setCapitalLongitude(1);
            country.setCountryCode1("cLw");
            country.setCountryCode2("Iti");
            country.setCountryFlag("TqemwD0PbgRSsdX0XJtKbbc36eUeNBk9Z1JcHYxCsn8gkIidZn");
            country.setCountryName("L7hcuoH1jggS1VPOxxqxWWwZqubI4ShUjJ037q9sPVqZjfDc6w");
            country.setCurrencyCode("SZe");
            country.setCurrencyName("TVNJrv3E5FCCNhI5dwsD5MuxdO2DPmB9vMDEMtByHI2J2VtSBJ");
            country.setCurrencySymbol("RSY99y7IN5Bav3YEfC7fsJLAMCGRkkTW");
            country.setIsoNumeric(9);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("K4FSE8TNTwd1HzFTdctEzx7T6nCEVK3BHeZSC5CN3kbJUjOEf2");
            currency.setUnicodeDecimal("D8OgxFFePtjLLZO4GahNycUYMNQZtpsIS6z3BwxWxvkLuWjTlD");
            currency.setUnicodeHex("FeJPmtbrdATNsGaO6Pd8UnnxwkYfUe228FYoJyv6nHweuCuvPE");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("gJ1r2ljMXLOjy6IQT4uLMjmc2F5svRL8CV3sTeNOHgvc43YoOh");
            currency.setUnicodeDecimal("n8anclqo5Fz74yJW0h0YwtRkMQzM8ZwGpmAzLDm1PxtShKme8S");
            currency.setUnicodeHex("NGHBNZqadpKhxZLCOukka0jFhTJjBXbsgCS75HWEKxKLTrZmIl");
