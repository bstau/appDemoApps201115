...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("HAp2GIiZt1vGE3V5MxbyL8tTC1XdHJkSkv0tqsbtB3BykWSw7q");
            question.setQuestionDetails("utq");
            question.setQuestionIcon("K8yfGXctGP87151EcUXYwhPDtThYRk9PgainkTSJh0BvGaRMGA");
    ...
    public void test2Update() {
        try {
            ...
            question.setLevelid(1);
            question.setQuestion("nr6sSV77JEKyhOY8mprYKrLXPYysljFDnjzaBw8T8MZout9sAV");
            question.setQuestionDetails("nU3");
            question.setQuestionIcon("B4mKfoO2WDKp4vjqqdTON5Sq723UEIFIrBdq76uQZbJuKWl79X");
