package com.survey.app.shared.customers;
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            com.survey.app.shared.customers.AppCustomerCategory other = (com.survey.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
