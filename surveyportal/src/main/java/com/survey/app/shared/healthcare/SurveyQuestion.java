...
@Entity
@NamedQueries({ @javax.persistence.NamedQuery(name = "SurveyQuestion.DefaultFinders", query = "select e from SurveyQuestion e where e.systemInfo.activeStatus=1 and e.surveyQuestionGroupId BETWEEN :minsurveyQuestionGroupId AND :maxsurveyQuestionGroupId"), @javax.persistence.NamedQuery(name = "SurveyQuestion.findBySurveyQuestionGroupId", query = "select e from SurveyQuestion e where e.systemInfo.activeStatus=1 and e.surveyQuestionGroupId=:surveyQuestionGroupId"), @javax.persistence.NamedQuery(name = "SurveyQuestion.findById", query = "select e from SurveyQuestion e where e.systemInfo.activeStatus=1 and e.surveyQuestionId =:surveyQuestionId"), @javax.persistence.NamedQuery(name = "GeneralHealth", query = "SELECT surveyQuestion FROM SurveyQuestion AS surveyQuestion WHERE surveyQuestion.surveyQuestionGroupId = 4 "), @javax.persistence.NamedQuery(name = "BehaviouralReadlinessToChanges", query = "SELECT surveyQuestion FROM SurveyQuestion AS surveyQuestion WHERE surveyQuestion.surveyQuestionGroupId = 3 "), @javax.persistence.NamedQuery(name = "LifeStyleQuestions", query = "SELECT surveyQuestion FROM SurveyQuestion AS surveyQuestion WHERE surveyQuestion.surveyQuestionGroupId like 2 "), @javax.persistence.NamedQuery(name = "CHDRisk", query = "SELECT surveyQuestion FROM SurveyQuestion AS surveyQuestion WHERE surveyQuestion.surveyQuestionGroupId = 1 ") })
public class SurveyQuestion implements Serializable, CommonEntityInterface, Comparator<SurveyQuestion> {
    ...
    public SurveyQuestion addSurveyAnswer(SurveyAnswer _surveyAnswer) {
        if (this.surveyAnswer == null) {
            this.surveyAnswer = new java.util.ArrayList<com.survey.app.shared.healthcare.SurveyAnswer>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.survey.app.shared.healthcare.SurveyQuestion other = (com.survey.app.shared.healthcare.SurveyQuestion) obj;
            if (surveyQuestionId == null) {
                return false;
