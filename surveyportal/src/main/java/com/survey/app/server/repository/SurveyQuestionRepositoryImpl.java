...
public class SurveyQuestionRepositoryImpl extends SearchInterfaceImpl implements SurveyQuestionRepository<SurveyQuestion> {
    ...
    public List<SurveyQuestion> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.survey.app.shared.healthcare.SurveyQuestion> query = emanager.createQuery("select u from SurveyQuestion u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public SurveyQuestion save(SurveyQuestion entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<com.survey.app.shared.healthcare.SurveyAnswer> surveyanswer = new java.util.ArrayList<com.survey.app.shared.healthcare.SurveyAnswer>();
            for (java.util.Iterator iterator = entity.getSurveyAnswer().iterator(); iterator.hasNext(); ) {
                com.survey.app.shared.healthcare.SurveyAnswer childEntity = (com.survey.app.shared.healthcare.SurveyAnswer) iterator.next();
                if (childEntity.getPrimaryKey() != null) {
                    com.survey.app.shared.healthcare.SurveyAnswer ans = emanager.find(SurveyAnswer.class, childEntity.getPrimaryKey());
    ...
    public List<SurveyQuestion> save(List<SurveyQuestion> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.survey.app.shared.healthcare.SurveyQuestion obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.survey.app.shared.healthcare.SurveyQuestion s = emanager.find(com.survey.app.shared.healthcare.SurveyQuestion.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteSurveyAnswer(List<SurveyAnswer> surveyanswer) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (com.survey.app.shared.healthcare.SurveyAnswer _surveyanswer : surveyanswer) {
                com.survey.app.shared.healthcare.SurveyAnswer s = emanager.find(com.survey.app.shared.healthcare.SurveyAnswer.class, _surveyanswer.getSurveyAnswerId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public List<SurveyQuestion> findBySurveyQuestionGroupId(Integer surveyQuestionGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.survey.app.shared.healthcare.SurveyQuestion> listOfSurveyQuestion = query.getResultList();
    ...
    public SurveyQuestion findById(String surveyQuestionId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.survey.app.shared.healthcare.SurveyQuestion listOfSurveyQuestion = (com.survey.app.shared.healthcare.SurveyQuestion) query.getSingleResult();
            return listOfSurveyQuestion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
    ...
    @Transactional
    public List<SurveyQuestion> GeneralHealth() throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("GeneralHealth");
    ...
    @Transactional
    public List<SurveyQuestion> BehaviouralReadlinessToChanges() throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("BehaviouralReadlinessToChanges");
            List<SurveyQuestion> listOfSurveyQuestion = query.getResultList();
            return listOfSurveyQuestion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
    ...
    @Transactional
    public List<SurveyQuestion> CHDRisk() throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CHDRisk");
            List<SurveyQuestion> listOfSurveyQuestion = query.getResultList();
            return listOfSurveyQuestion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
