package com.survey.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* com.survey.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.survey.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.survey.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.survey.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.survey.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.survey.app.server.repository..*(..))")
