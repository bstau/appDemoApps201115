...
public interface SurveyQuestionRepository<T> extends SearchInterface {
    ...
    public List<T> GeneralHealth() throws Exception, SpartanPersistenceException;

    public List<T> BehaviouralReadlinessToChanges() throws Exception, SpartanPersistenceException;

    public List<T> LifeStyleQuestions() throws Exception, SpartanPersistenceException;

    public List<T> CHDRisk() throws Exception, SpartanPersistenceException;
}
