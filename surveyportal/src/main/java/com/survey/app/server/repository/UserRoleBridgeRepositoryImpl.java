...
import com.survey.app.shared.authorization.UserRoleBridge;
...
public class UserRoleBridgeRepositoryImpl extends SearchInterfaceImpl implements UserRoleBridgeRepository<UserRoleBridge> {
    ...
    public List<UserRoleBridge> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.survey.app.shared.authorization.UserRoleBridge> query = emanager.createQuery("select u from UserRoleBridge u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<UserRoleBridge> save(List<UserRoleBridge> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.survey.app.shared.authorization.UserRoleBridge obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.survey.app.shared.authorization.UserRoleBridge s = emanager.find(com.survey.app.shared.authorization.UserRoleBridge.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<UserRoleBridge> findByRoleId(String roleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.survey.app.shared.authorization.UserRoleBridge> listOfUserRoleBridge = query.getResultList();
    ...
    public UserRoleBridge findById(String roleUserMapId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.survey.app.shared.authorization.UserRoleBridge listOfUserRoleBridge = (com.survey.app.shared.authorization.UserRoleBridge) query.getSingleResult();
            return listOfUserRoleBridge;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
