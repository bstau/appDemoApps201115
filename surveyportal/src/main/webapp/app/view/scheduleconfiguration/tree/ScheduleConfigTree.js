 ...
 * 
 */
Ext.define("Surveyportal.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Surveyportal.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
