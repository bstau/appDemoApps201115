Ext
		.define(
				'Surveyportal.view.mobileview.reportui.querycriteria.QueryCriteriaView',
				{
					extend : 'Ext.panel.Panel',
					requires : [ 'Surveyportal.view.mobileview.reportui.querycriteria.QueryCriteriaController' ],
					xtype : 'querycriteria',
