Ext.define('Surveyportal.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Surveyportal.view.usermanagement.admin.UserPasswordReset',
	            'Surveyportal.view.usermanagement.admin.AddUserDetails',
	            'Surveyportal.view.usermanagement.admin.ViewUser'],
