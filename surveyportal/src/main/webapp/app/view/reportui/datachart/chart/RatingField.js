...
Ext.define('Surveyportal.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Surveyportal.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Surveyportal.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
