Ext.define('Surveyportal.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Surveyportal.view.reportui.datachart.chart.RatingField','Surveyportal.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
