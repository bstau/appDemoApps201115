 ...
 * 
 */
Ext.define('Surveyportal.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Surveyportal.view.securityconfig.SecurityConfigController',
			'Surveyportal.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
