 ...
 * 
 */
Ext.define('Surveyportal.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Surveyportal.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Surveyportal.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
