Ext
		.define(
				'Surveyportal.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Surveyportal.view.searchengine.search.documentController',
							'Surveyportal.view.searchengine.search.RowExpander' ],
