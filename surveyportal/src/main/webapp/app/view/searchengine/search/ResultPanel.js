Ext
		.define(
				'Surveyportal.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Surveyportal.view.searchengine.search.SearchEngineMainPanelController','Surveyportal.view.searchengine.search.PanelHeaderField' ,'Surveyportal.view.searchengine.search.ReportGridView','Surveyportal.view.searchengine.search.ReportChartView','Surveyportal.view.searchengine.search.documentView','Surveyportal.view.searchengine.search.DouMeanView','Surveyportal.view.googlemaps.map.MapPanel'],
