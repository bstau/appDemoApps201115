 ...
 * 
 */
Ext.define('Surveyportal.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Surveyportal.view.logalarm.LogAlarmMainViewController',
			'Surveyportal.view.logalarm.tree.LogAlarmTreePanel',
			'Surveyportal.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
