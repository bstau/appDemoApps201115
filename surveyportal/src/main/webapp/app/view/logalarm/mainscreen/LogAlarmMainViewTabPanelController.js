 ...
 * 
 */
Ext.define('Surveyportal.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Surveyportal.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
