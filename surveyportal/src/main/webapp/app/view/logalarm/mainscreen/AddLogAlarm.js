 ...
 * 
 */
Ext.define('Surveyportal.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Surveyportal.view.logalarm.mainscreen.AddLogAlarmController',
			'Surveyportal.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Surveyportal.view.logalarm.mainscreen.AppAlarmPanel',
