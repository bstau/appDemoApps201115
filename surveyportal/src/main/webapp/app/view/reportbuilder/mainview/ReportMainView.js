Ext.define('Surveyportal.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Surveyportal.view.reportbuilder.reportlist.ReportListPanelView',
             'Surveyportal.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Surveyportal.view.reportbuilder.mainview.ReportMainController'
             ],
