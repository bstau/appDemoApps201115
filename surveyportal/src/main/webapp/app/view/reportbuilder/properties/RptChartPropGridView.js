Ext.define('Surveyportal.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Surveyportal.view.reportbuilder.properties.RptChartPropGridController'],
