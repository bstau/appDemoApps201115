Ext.define('Surveyportal.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Surveyportal.view.reportbuilder.properties.RptDrillDownGridController'],
