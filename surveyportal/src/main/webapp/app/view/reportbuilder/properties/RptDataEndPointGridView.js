Ext.define('Surveyportal.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Surveyportal.view.reportbuilder.properties.RptDataEndPointGridController'],
