Ext.define('Surveyportal.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Surveyportal.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Surveyportal.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Surveyportal.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Surveyportal.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
