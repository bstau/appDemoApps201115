Ext.define('Surveyportal.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Surveyportal.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Surveyportal.view.reportbuilder.gridconfig.GridConfigView',
	           'Surveyportal.view.reportbuilder.properties.PropertiesPanelView',
	           'Surveyportal.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
