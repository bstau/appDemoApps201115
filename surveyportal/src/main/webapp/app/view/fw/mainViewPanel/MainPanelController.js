Ext.define('Surveyportal.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Surveyportal.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Surveyportal.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
