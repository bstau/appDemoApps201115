...
Ext
		.define(
				'Surveyportal.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Surveyportal.view.logger.tabs.details.DetailsTab',
							'Surveyportal.view.logger.tabs.fileconnector.FileConnectorTab',
							'Surveyportal.view.logger.tabs.dbconnector.DBConnectorTab',
							'Surveyportal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Surveyportal.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Surveyportal.view.logger.LogConfigurationTabPanelController',
