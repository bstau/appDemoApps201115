 ...
 * 
 */
Ext.define('Surveyportal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Surveyportal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
