 ...
 * 
 */
Ext.define('Surveyportal.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Surveyportal.view.logger.tabs.fileconnector.FileConnectorTabController'],
