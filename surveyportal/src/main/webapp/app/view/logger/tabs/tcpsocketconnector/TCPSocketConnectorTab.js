...
Ext
		.define(
				'Surveyportal.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Surveyportal.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
