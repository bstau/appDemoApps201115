Ext.define('Surveyportal.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Surveyportal.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Surveyportal.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Surveyportal.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Surveyportal.view.querybuildernewmodel.querydetail.QueryDetail');
