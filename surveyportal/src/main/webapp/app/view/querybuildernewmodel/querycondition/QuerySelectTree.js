Ext.define('Surveyportal.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Surveyportal.view.querybuildernewmodel.querycondition.QuerySelectController',
