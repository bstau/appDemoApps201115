Ext.define('Surveyportal.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Surveyportal.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
