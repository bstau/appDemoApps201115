Ext.define('Surveyportal.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Surveyportal.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Surveyportal.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Surveyportal.view.querybuildernewmodel.floatingentity.EntitySprite',
