Ext.define('Surveyportal.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Surveyportal.view.resource.ResourcePanel',
			'Surveyportal.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Surveyportal.view.resource.DockedResourcePanel','Surveyportal.view.fw.mainViewPanel.MainPanelController' ],
