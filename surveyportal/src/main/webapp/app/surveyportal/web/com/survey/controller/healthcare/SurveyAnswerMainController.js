Ext.define('Surveyportal.surveyportal.web.com.survey.controller.healthcare.SurveyAnswerMainController', {
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#SurveyAnswerTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#SurveyAnswer');
          var grid = this.view.down('#SurveyAnswerGrid');
          var tree = this.view.down('#SurveyAnswerTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#SurveyAnswerGrid');
               ...
               var formPanel = this.getView().up().down("#SurveyAnswer");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().down('#SurveyAnswerTree');
     ...
     loadData: function(responseData) {
          this.view.down('#SurveyAnswer').getViewModel().setData(responseData.response.data);
     },
